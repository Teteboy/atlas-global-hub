...
export default function About() {
  ...
  const values = [
    { num: "01", title: t("Rigueur analytique", "Analytical rigor"), desc: t("Chaque diagnostic repose sur une analyse approfondie du contexte institutionnel, politique et économique.", "Every diagnosis rests on a thorough analysis of the institutional, political and economic context.") },
    { num: "02", title: t("Exécution centrée résultats", "Results-centered execution"), desc: t("Nous croyons que la stratégie sans mise en œuvre reste une intention. Atlas accompagne jusqu'à la ligne d'arrivée.", "We believe strategy without implementation remains an intention. Atlas accompanies you to the finish line.") },
    { num: "03", title: t("Intégrité & Transparence", "Integrity & Transparency"), desc: t("Nos mandats sont conduits avec éthique, clarté et responsabilité envers les parties prenantes.", "Our mandates are conducted with ethics, clarity and accountability towards all stakeholders.") },
    { num: "04", title: t("Ancrage local, vision globale", "Local roots, global vision"), desc: t("Compréhension des réalités de terrain combinée à une expertise des marchés internationaux.", "Understanding of on-the-ground realities combined with expertise in international markets.") },
  ];
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              { step: "01", title: t("Diagnostic", "Diagnosis"), desc: t("Analyse contextuelle, cartographie des enjeux, identification des leviers d'action.", "Contextual analysis, stakeholder mapping, identification of action levers."), img: "https://images.unsplash.com/photo-1434626881859-194d67b2b86f?auto=format&fit=crop&w=600&q=80" },
              { step: "02", title: t("Conception", "Design"), desc: t("Élaboration de la stratégie, du cadre logique et des outils de mise en œuvre.", "Developing the strategy, logical framework and implementation tools."), img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=600&q=80" },
              { step: "03", title: t("Exécution", "Execution"), desc: t("Pilotage opérationnel, gestion des parties prenantes, suivi de la performance.", "Operational steering, stakeholder management, performance monitoring."), img: "https://images.unsplash.com/photo-1531973576160-7125cd663d86?auto=format&fit=crop&w=600&q=80" },
              { step: "04", title: t("Impact & Capitalisation", "Impact & Learning"), desc: t("Évaluation de l'impact, documentation des apprentissages, valorisation des résultats.", "Impact assessment, learning documentation, result dissemination."), img: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=600&q=80" },
            ].map((step, i) => (
